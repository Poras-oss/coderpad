...
export default function SQLCourseLandingPage() {
  ...
  return (
    ...
    <div className={`w-full min-h-screen ${
      isDarkMode ? "bg-[#1D1E23]" : "bg-gray-100"
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-20 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1">
          <span className={`inline-flex items-center px-4 py-1 rounded-full text-sm font-semibold mb-4 ${
          ...
          <p className={`mt-5 text-lg md:max-w-xl ${
      ...
      <section className={` py-16 ${
        isDarkMode ? "bg-[#1D1E23] border-gray-700" : "bg-white border-slate-200"
      }`}>
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className={`border p-7 rounded-2xl shadow-sm ${
                  isDarkMode 
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <div
              key={i}
              className={`border p-5 rounded-xl hover:border-emerald-500 transition ${
                isDarkMode 
                  ? "bg-[#32363C] border-[#2f2f2f]" 
      ...
      <section 
        ...
        className={` py-16 ${
          isDarkMode ? "bg-[#1D1E23] border-gray-700" : "bg-slate-100 border-slate-200"
        }`}
      >
        <div className="max-w-6xl mx-auto px-6">
          <h2 className={`text-3xl font-bold text-center mb-10 ${
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {/* Google Drive Plan */}
            <div className={`border rounded-2xl shadow-sm p-6 flex flex-col gap-6 ${
              isDarkMode 
                ? "bg-[#32363C] border-[#2f2f2f]" 
                : "bg-white border-slate-200"
            }`}>
              ...
              <div className={`w-full border group ${
                isDarkMode ? "border-[#2f2f2f]" : "border-slate-200"
              }`}>
                <img
            ...
            {/* Topmate Plan */}
            <div className={`border rounded-2xl shadow-sm p-6 flex flex-col gap-4 ${
              isDarkMode 
                ? "bg-[#32363C] border-[#2f2f2f]" 
                : "bg-white border-slate-200"
            }`}>
              ...
              <div className={`w-full rounded-xl  border group ${
                isDarkMode ? "border-[#2f2f2f]" : "border-slate-200"
              }`}>
                <img
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {pdfResources.map((pdf, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`border rounded-2xl p-5 shadow-sm flex flex-col justify-between hover:border-emerald-500 transition ${
                  isDarkMode 
                    ? "bg-[#32363C] border-[#2f2f2f]" 
                    : "bg-white border-slate-200"
                }`}
          ...
          <div className="overflow-x-auto flex gap-6 pb-2">
            {["This is the first time SQL actually made sense.","Your real-world problems helped me clear interviews.","Perfect for beginners — explanations are super clear and practical."].map(
              (t, i) => (
                <div
                  key={i}
                  className={`min-w-[280px] md:min-w-[320px] border p-6 rounded-2xl shadow-sm ${
                    isDarkMode 
                      ? "bg-[#32363C] border-[#2f2f2f]" 
                      : "bg-white border-slate-200"
                  }`}
      ...
      {/* FOOTER */}
      <footer className={`text-center py-8 text-xs md:text-sm border-t ${
        isDarkMode 
        ...
        <div className="flex justify-center gap-5 mb-3 text-lg">
          <i className={`ri-instagram-line cursor-pointer ${
            isDarkMode ? "hover:text-gray-200" : "hover:text-slate-700"
          }`} />
          <i className={`ri-linkedin-box-line cursor-pointer ${
            isDarkMode ? "hover:text-gray-200" : "hover:text-slate-700"
          }`} />
          <i className={`ri-twitter-line cursor-pointer ${
            isDarkMode ? "hover:text-gray-200" : "hover:text-slate-700"
          }`} />
        </div>
