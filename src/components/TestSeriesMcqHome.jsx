...
const TestSeriesMcqHome = () => {
  ...
  //               </div>
  //               <p className={`mb-4 text-sm sm:text-base lg:text-lg ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} line-clamp-3 sm:line-clamp-none break-words`}>
  //                 {quiz.description}
  //               </p>
  //               <button
  ...
  //           <p className={`text-center text-xs sm:text-sm md:text-base lg:text-lg ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} break-words`}>
