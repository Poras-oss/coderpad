  ...
  const fetchLessonQuestions = useCallback(
    async (subtopic) => {
      try {
        ...
        // REMOVED THE PROBLEMATIC `if` CHECK FROM HERE
    ...
    [subject, filters, solvedQuestions, getUserID] // <-- removed loadedLessons from dependencies
  );
            ...
            <div className="flex-1">
              ...
              >
                ...
                <a
                  ...
                  // onClick={() => (window.location.href = 'https://dashboard.datasenseai.com/sql-journey')}
                >
                  View Roadmap
                </a>
              </div>
              ...
              >
                ...
                >
                  <div className="h-48 rounded-lg flex items-center justify-center">
                    ...
                    {/* <span className={`text-4xl ${isDarkMode ? 'text-white' : 'text-gray-700'}`}>🏅</span> */}
                    <img
                      className="h-48 w-68"
                      src={certificate}
                      alt="certificate"
