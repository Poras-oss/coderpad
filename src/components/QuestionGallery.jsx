  ...
  const fetchLessonQuestions = useCallback(
    async (subtopic) => {
      try {
        ...
        // Inside fetchLessonQuestions function, after setting lessonQuestions:
        const difficultyCount = results.reduce((acc, quiz) => {
          const difficulty = quiz.difficulty.toLowerCase();
          acc[difficulty] = (acc[difficulty] || 0) + 1;
          return acc;
        }, {});

        console.log(`${subtopic} Questions Count:`, {
          easy: difficultyCount.easy || 0,
          medium: difficultyCount.medium || 0,
          advanced: difficultyCount.advanced || 0,
