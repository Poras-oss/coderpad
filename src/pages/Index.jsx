...
import LearnSQLPopup from '../components/home/LearnSQLPopup';
...
const Index = () => {
  ...
  const handleOpenLearnSQLPopup = () => {
    playButtonClick();
    setLearnSQLPopupOpen(true);
  };
  ...
  return (
    <div className="relative landing-page-body w-full h-full">
      ...
      <CyberNav onLearnSQLClick={handleOpenLearnSQLPopup} />
      ...
      <LearnSQLPopup
        open={learnSQLPopupOpen}
        onClose={() => setLearnSQLPopupOpen(false)}
      />
